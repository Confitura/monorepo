                    ...
                    <form @submit="save" class="col s12" novalidate>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <md-field :class="{'md-invalid': errors.has('t-shirt size')}">
                                    ...
                                    <span class="md-error">{{ errors.first('t-shirt size') }}</span>
                        ...
                        <div class="row">
                            <md-field :class="{'md-invalid': errors.has('meal option')}">
                                ...
                                <md-select v-model="form.mealOption" name="meal option" id="meal-option" required
                                           v-validate="'required'">
                        ...
                        <div class="row">
                            <strong>Food note:</strong> We can't guarantee that you will be able to get option that you have selected. The
                            food at confitura will not be portioned, so first come - first served.
                        </div>
                        <div class="row">
                            <md-field :class="{'md-invalid': errors.has('city')}">
                                <label>city</label>
                                <md-input v-model="form.city" maxlength="255" required v-validate="'required'" name="city"></md-input>
                        ...
                        <div class="row">
                            <md-checkbox v-model="form.privacyPolicyAccepted" required v-validate="'required'" name="privacy policy">I
                                accept the
